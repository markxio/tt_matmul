...
void matmul_single_core(
    ...
    auto reader_id = tt_metal::CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "tt_metal/programming_examples/matmul/matmul_single_core/kernels/dataflow/reader_single_core_mm.cpp",
        core,
    ...
    auto writer_id = tt_metal::CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "tt_metal/programming_examples/matmul/matmul_single_core/kernels/dataflow/writer_single_core_mm.cpp",
        core,
        tt_metal::DataMovementConfig{
    ...
    tt_metal::CreateKernel(
        program,
        OVERRIDE_KERNEL_PREFIX "tt_metal/programming_examples/matmul/matmul_single_core/kernels/compute/mm.cpp",
        core,
